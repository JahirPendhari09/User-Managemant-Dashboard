      ...
      <div className="sm:w-90 lg:w-96  p-5">
        <h2 className="text-center text-2xl text-red-500">Edit User</h2>
          <form class="max-w-sm mx-auto" onSubmit={updateTask}>
            <div>
              <label className="block mb-2 text-sm text-left font-medium text-gray-900 dark:text-black">Edit firstName</label>
            ...
            <div>
              <label className="block mb-2 mt-2 text-left text-sm font-medium text-gray-900 dark:text-black">Edit lastName</label>
            ...
            <div>
              <label className="block mb-2 mt-2 text-left text-sm font-medium text-gray-900 dark:text-black">Edit Email</label>
            ...
            <div>
              <label className="block mb-2 mt-2 text-left text-sm font-medium text-gray-900 dark:text-black">Edit Department</label>
